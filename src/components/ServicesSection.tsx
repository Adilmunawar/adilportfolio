...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      gradient: 'from-teal-800 to-blue-800',
      accentColor: '#14b8a6'
    },
    {
      Icon: Zap,
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <Card 
              key={index} 
              className="group relative p-8 bg-cyber-gray/30 border-cyber-purple/30 hover:border-cyber-purple/60 transition-all duration-700 hover:scale-105 backdrop-blur-xl animate-scale-in overflow-hidden"
              style={{ animationDelay: `${index * 0.1}s`, borderColor: 'hsl(var(--border))' }}
            >
              ...
              {/* Glow effect */}
              <div className="absolute -inset-1 bg-gradient-to-r from-cyber-purple/20 to-cyber-blue/20 rounded-lg blur opacity-0 group-hover:opacity-100 transition-all duration-700"></div>
              ...
              <div className="relative text-center">
                ...
                <h3 className="text-xl font-bold mb-4 text-white drop-shadow-md group-hover:text-gray-100 transition-colors duration-500" style={{color: service.accentColor}}>{service.title}</h3>
              ...
              <div className="absolute inset-0 border-2 border-transparent group-hover:border-cyber-purple/40 rounded-lg transition-all duration-700"></div>
              
              {/* Corner accents */}
              <div className="absolute top-2 right-2 w-4 h-4 border-t-2 border-r-2 border-cyber-purple/30 group-hover:border-cyber-purple/60 transition-colors duration-500"></div>
              <div className="absolute bottom-2 left-2 w-4 h-4 border-b-2 border-l-2 border-cyber-purple/30 group-hover:border-cyber-purple/60 transition-colors duration-500"></div>
            </Card>
          ))}
        </div>
      </div>
